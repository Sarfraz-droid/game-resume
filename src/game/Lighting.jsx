...
export default function Lighting() {
  return (
    <>
      <hemisphereLight args={['#dceeff', '#5d6541', 0.64]} />
      ...
      <directionalLight position={[-40, 26, 34]} intensity={0.38} color="#bcd4ff" />
      ...
      <Environment resolution={128} frames={1}>
        ...
        <Lightformer intensity={1.2} position={[-8, 5, -6]} scale={[9, 9, 1]} color="#bcd4ff" />
